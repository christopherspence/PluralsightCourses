...
@implementation AppDelegate { } 
	...
	-(id) window
	{
		...
		return native_to_managed_trampoline_1 (self, _cmd, &managed_method, "PluralsightCourses.iOS.AppDelegate, PluralsightCoursesiOS, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "get_Window");
	}

	-(void) setWindow:(id)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_2 (self, _cmd, &managed_method, p0, "MonoTouch.UIKit.UIWindow, monotouch, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", "PluralsightCourses.iOS.AppDelegate, PluralsightCoursesiOS, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "set_Window");
	}

	-(bool) application:(id)p0 didFinishLaunchingWithOptions:(id)p1
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_3 (self, _cmd, &managed_method, p0, p1, "MonoTouch.UIKit.UIApplication, monotouch, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", "MonoTouch.Foundation.NSDictionary, monotouch, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", "PluralsightCourses.iOS.AppDelegate, PluralsightCoursesiOS, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "FinishedLaunching");
	}

	-(void) applicationWillResignActive:(id)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_2 (self, _cmd, &managed_method, p0, "MonoTouch.UIKit.UIApplication, monotouch, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", "PluralsightCourses.iOS.AppDelegate, PluralsightCoursesiOS, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "OnResignActivation");
	}

	-(void) applicationDidEnterBackground:(id)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_2 (self, _cmd, &managed_method, p0, "MonoTouch.UIKit.UIApplication, monotouch, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", "PluralsightCourses.iOS.AppDelegate, PluralsightCoursesiOS, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "DidEnterBackground");
	}

	-(void) applicationWillEnterForeground:(id)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_2 (self, _cmd, &managed_method, p0, "MonoTouch.UIKit.UIApplication, monotouch, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", "PluralsightCourses.iOS.AppDelegate, PluralsightCoursesiOS, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "WillEnterForeground");
	}

	-(void) applicationWillTerminate:(id)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_2 (self, _cmd, &managed_method, p0, "MonoTouch.UIKit.UIApplication, monotouch, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", "PluralsightCourses.iOS.AppDelegate, PluralsightCoursesiOS, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "WillTerminate");
	}
	...
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_5 (self, _cmd, &managed_method, "PluralsightCourses.iOS.AppDelegate, PluralsightCoursesiOS, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", ".ctor");
	}
@end

@interface PluralsightCourses_iOS_MyViewController : UIViewController {
	void *__monoObjectGCHandle;
}
	-(void) release;
	-(id) retain;
	...
	-(id) init;
@end
@implementation PluralsightCourses_iOS_MyViewController { } 
	-(void) release
	{
		monotouch_release_trampoline (self, _cmd);
	}
	...
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_6 (self, _cmd, &managed_method, "PluralsightCourses.iOS.MyViewController, PluralsightCoursesiOS, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "ViewDidLoad");
	}
	...
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_5 (self, _cmd, &managed_method, "PluralsightCourses.iOS.MyViewController, PluralsightCoursesiOS, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", ".ctor");
	}
@end
...
@end
	...
	static MTClassMap __monotouch_class_map [] = {
		...
		{"AppDelegate", "PluralsightCourses.iOS.AppDelegate, PluralsightCoursesiOS, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", NULL },
		...
		{"PluralsightCourses_iOS_MyViewController", "PluralsightCourses.iOS.MyViewController, PluralsightCoursesiOS, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", NULL },
...
void monotouch_create_classes () {
	...
	__monotouch_class_map [4].handle = [PluralsightCourses_iOS_MyViewController class];
	...
	__monotouch_class_map [12].handle = objc_getClass ("UIColor");
	__monotouch_class_map [13].handle = objc_getClass ("MonoTouch_UIKit_UIControlEventProxy");
	__monotouch_class_map [14].handle = objc_getClass ("UIScreen");
	__monotouch_class_map [15].handle = objc_getClass ("UIWindow");
	__monotouch_class_map [16].handle = objc_getClass ("NSException");
	__monotouch_class_map [17].handle = objc_getClass ("NSDictionary");
	__monotouch_class_map [18].handle = objc_getClass ("__NSObject_Disposer");
	monotouch_setup_classmap (__monotouch_class_map, 19);
}
